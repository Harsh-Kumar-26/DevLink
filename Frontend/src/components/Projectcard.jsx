...
export default function ProjectCard({pjtid}) {
  ...
  return (isloding || !project || !creator)?<Loader/>:(
    <motion.div
  className="bg-gradient-to-b from-white/5 to-white/0 bg-white/5 backdrop-blur-sm border border-gray-700 rounded-2xl p-5 shadow-md hover:shadow-xl transition duration-300 flex flex-col gap-4 mb-60px"
