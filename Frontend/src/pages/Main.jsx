...
//               className="fixed top-0 left-0 z-40 h-full w-72 bg-gradient-to-b from-[#121829] to-[#1f2a41] p-6 flex flex-col shadow-2xl rounded-tr-3xl rounded-br-3xl md:static md:shadow-none md:rounded-none"
//             >
...
//         {/* Header */}
//         <header className="bg-black flex items-center justify-between px-6 py-4 border-b border-teal-700 bg-[#122337] shadow-sm sticky top-0 z-10">
//           <Button
...
//         {/* Projects & Outlet */}
//         <main className="flex-1 overflow-y-auto p-6 space-y-6 bg-[#0f1a2a]">
